...
namespace NSE.Identidade.API.Extensions
{
    public class IdentityMensagensPtBr : IdentityErrorDescriber
    {
        ...
        public override IdentityError ConcurrencyFailure() { return new IdentityError { Code = nameof(ConcurrencyFailure), Description = $"Falha de concorrência, objeto modificado" }; }
        ...
        public override IdentityError InvalidUserName(string userName) { return new IdentityError { Code = nameof(InvalidUserName), Description = $"O login '{userName}' é inválido, poode conter apenas letras" }; }
        ...
        public override IdentityError UserLockoutNotEnabled() { return new IdentityError { Code = nameof(UserLockoutNotEnabled), Description = $"O lockout não está habilitado para esse usuário" }; }
        ...
        public override IdentityError PasswordRequiresNonAlphanumeric() { return new IdentityError { Code = nameof(PasswordRequiresNonAlphanumeric), Description = $"As senhas devem conter ao menos um caracter especial" }; }
        ...
        public override IdentityError PasswordRequiresLower() { return new IdentityError { Code = nameof(PasswordRequiresLower), Description = $"As senhas devem conter ao menos um caracter em caixa baixa" }; }
        public override IdentityError PasswordRequiresUpper() { return new IdentityError { Code = nameof(PasswordRequiresUpper), Description = $"As senhas devem conter ao menos um caracter em caixa alta" }; }
        #endregion
    }
}
